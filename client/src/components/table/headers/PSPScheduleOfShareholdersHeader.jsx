const PSPScheduleOfShareholdersHeader = () => {
  return (
    <thead className="">
      <tr className="text-white">
        ...
        <th className="border p-4 bg-[#04AA6D]">NATIONALITY_OF_SHAREHOLDER</th>
        <th className="border p-4 bg-[#04AA6D]">COUNTRY_OF_RESIDENCE</th>
        <th className="border p-4 bg-[#04AA6D]">COUNTRY_OF_INCORPORATION</th>
        ...
        <th className="border p-4 bg-[#04AA6D]">DATE_ONE_BECAME_SHAREHOLDER</th>
        <th className="border p-4 bg-[#04AA6D]">NUMBERS_OF_SHARES_HELD</th>
...
export default PSPScheduleOfShareholdersHeader;
